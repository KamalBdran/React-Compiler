...
public class ReactjsParser extends Parser {
	...
	public static final int
		CLASS=1, EXTENDS=2, REACT_PURE_COMPONENT=3, RENDER=4, RETURN=5, EXPORT=6, 
		DEFAULT=7, IF=8, ELSE=9, FOR=10, CLASS_NAME=11, VAR=12, CONST=13, PROPS=14, 
		USESTATE=15, USEEFFECT=16, USEREF=17, LENGTH=18, PUSH=19, ONCLICK=20, 
		OPEN_SQUARE_BRACKETS=21, CLOSE_SQUARE_BRACKETS=22, OPEN_CURLY_BRACKETS=23, 
		CLOSE_CURLY_BRACKETS=24, OPEN_PARENTHSES=25, CLOSE_PARENTHSES=26, OPEN_TAG=27, 
		CLOSE_TAG=28, ARROW=29, SLASH=30, EQUALS=31, DOUBLE_QUOTES=32, DOT=33, 
		COMMA=34, COLON=35, SIMICOLON=36, EX=37, PLUS=38, OR=39, AND=40, BOOLEAN=41, 
		WORD_WITH_CAPITAL=42, ID=43, NUMBER=44, WS=45;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'class'", "'extends'", "'React.PureComponent'", "'render'", "'return'", 
			"'export'", "'default'", "'if'", "'else'", "'for'", "'className'", null, 
			"'const'", "'props'", "'useState'", "'useEffect'", "'useRef'", "'length'", 
			"'push'", "'onClick'", "'['", "']'", "'{'", "'}'", "'('", "')'", "'<'", 
			"'>'", "'=>'", "'/'", "'='", "'\"'", "'.'", "','", "':'", "';'", "'!'", 
			"'+'", "'||'", "'&&'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "CLASS", "EXTENDS", "REACT_PURE_COMPONENT", "RENDER", "RETURN", 
			"EXPORT", "DEFAULT", "IF", "ELSE", "FOR", "CLASS_NAME", "VAR", "CONST", 
			"PROPS", "USESTATE", "USEEFFECT", "USEREF", "LENGTH", "PUSH", "ONCLICK", 
			"OPEN_SQUARE_BRACKETS", "CLOSE_SQUARE_BRACKETS", "OPEN_CURLY_BRACKETS", 
			"CLOSE_CURLY_BRACKETS", "OPEN_PARENTHSES", "CLOSE_PARENTHSES", "OPEN_TAG", 
			"CLOSE_TAG", "ARROW", "SLASH", "EQUALS", "DOUBLE_QUOTES", "DOT", "COMMA", 
			"COLON", "SIMICOLON", "EX", "PLUS", "OR", "AND", "BOOLEAN", "WORD_WITH_CAPITAL", 
			"ID", "NUMBER", "WS"
		};
	}
	...
	public final ComponentBodyContext componentBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8796093101056L) != 0)) {
				{
				setState(154);
				_errHandler.sync(this);
